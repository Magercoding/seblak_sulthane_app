...
import 'package:seblak_sulthane_app/presentation/report/widgets/order_item_widget.dart';
                    ...
                    : SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_orderItems.isEmpty)
                              ...
                              ..._orderItems.map(
                                (item) => Padding(
                                  ...
                                  child: OrderItemWidget(data: item),
                                ),
                              ),
                            const SpaceHeight(16.0),
                            const Divider(),
                            ...
                            const SpaceHeight(12.0),
                            _buildSummaryRow(
                                'Sub Total', widget.order.subTotal),
                            _buildSummaryRow(
                                'Diskon',
                            ...
                            const Divider(),
                            const SpaceHeight(8.0),
                            _buildSummaryRow('Total', widget.order.total,
                                isTotal: true),
                            _buildSummaryRow(
                                'Bayar', widget.order.paymentAmount),
                            _buildSummaryRow(
                                'Kembalian',
