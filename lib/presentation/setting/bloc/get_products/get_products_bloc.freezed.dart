...
/// @nodoc
class $GetProductsEventCopyWith<$Res> {
  $GetProductsEventCopyWith(
      GetProductsEvent _, $Res Function(GetProductsEvent) __);
}

/// Adds pattern-matching-related methods to [GetProductsEvent].
extension GetProductsEventPatterns on GetProductsEvent {
...
class _Started implements GetProductsEvent {
  const _Started();
...
class _Fetch implements GetProductsEvent {
  const _Fetch();
...
class _Loading implements GetProductsState {
  const _Loading();
...
class _Success implements GetProductsState {
...
class _Error implements GetProductsState {
